...
const Page = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col justify-center items-center min-h-screen bg-[#f5f5f5]/20 px-4">
        <div className="mt-[120px] text-center">
          <h1 className="font-montserrat font-bold text-3xl text-[#050814] drop-shadow mb-10">
...
">
            ...
            <p className="text-[#050814] drop-shadow text-sm font-light font-montserrat max-w-md text-center">
          ...
          <p className="text-[#050814] drop-shadow text-sm font-light font-montserrat mb-10">
