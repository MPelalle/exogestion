...
const FifthSection = () => {
  return (
    <div className="bg-gradient-to-b from-[#050814] via-[#0A0F2C] to-[#050814] flex flex-col justify-center items-center w-full pt-[70px]">
      ...
      <h1 className="text-[#f5f5f5] font-montserrat font-extrabold text-[34px] md:text-[40px] text-center pt-4 tracking-wide drop-shadow-md transition-all duration-300 ease-in-out  hover:drop-shadow-xl">
...
'className="relative bg-[#297FFF] text-[#F5F5F5] font-montserrat font-bold text-2xl py-3 px-8 rounded-2xl mt-[25px] shadow-md cursor-pointer transition-all duration-300 ease-in-out hover:shadow-[0_0_25px_#297FFF] hover:scale-105 hover:brightness-110 group overflow-hidden">
