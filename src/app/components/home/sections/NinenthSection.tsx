...
>
  ...
  <h2 className="font-montserrat font-semibold text-sm text-yellow-300 text-center uppercase tracking-widest mb-6">
    De los creadores de Exogestión, nace Syrah
  </h2>
  <p className="font-montserrat font-light text-lg text-white max-w-4xl text-center leading-relaxed px-4">
  ...
  <h2 className="font-montserrat font-semibold text-lg text-yellow-400 mt-6 max-w-4xl text-center px-4">
    Si buscás llevar tu negocio gastronómico al próximo nivel, Syrah es la herramienta que necesitás.
  </h2>
  <button className="bg-yellow-500 hover:bg-yellow-600 transition-colors duration-300 text-black font-montserrat font-bold text-2xl py-3 px-8 rounded-full mt-8 shadow-lg">
    Conocé Syrah
  </button>
    </div>
  )
