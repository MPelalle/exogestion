...
const FourthSection = () => {
  ...
  return (
    <div className="bg-[#050814] flex justify-around items-center p-8 w-full flex flex-col lg:flex-row lg:gap-10 md:px-10">
        <div className="border-1 border-[#F5F5F5] p-4" data-aos="fade-left">
        ...
        <div className="border-1 border-[#F5F5F5] p-4" data-aos="fade-down">
        ...
        <div className="border-1 border-[#F5F5F5] p-4" data-aos="fade-right">
