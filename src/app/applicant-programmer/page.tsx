...
const Page = () => {
 ...
 return (
  <div>
    ...
    style={{ backgroundImage: 'url("./images/cards/programador.webp")' }}>
      <h1 className="font-montserrat font-bold text-4xl text-center text-[#F5F5F5] mb-4">
        Postulación para Programadores
      </h1>
      <p className="font-montserrat font-light text-lg text-center text-[#F5F5F5] max-w-xl mx-auto mb-6">
        Si deseas postularte a una vacante de programador, completa el formulario y nos pondremos en contacto contigo.
      </p>
      <hr className="w-[70%] border-[#F5F5F5] mx-auto my-8" /> 
      <p className="font-montserrat font-light text-lg text-center text-[#F5F5F5] max-w-xl mx-auto mb-4 px-4">
      ...
      <div className="flex justify-center">
        ...
        className="font-montserrat font-light text-md text-[#00000] border border-[#00D084] px-6 py-2 rounded-full bg-[#00D084] hover:text-[#f5f5f5] hover:bg-transparent transition cursor-pointer hover:shadow-lg">
